...
misplaced_list = ['Arrhythmia', 'Cardiotocography', 'Hepatitis', 'ALOI',
                  'KDDCup99']
arff_list = [
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..', 'data',
                                 'semantic', 'Arrhythmia', 'Arrhythmia_withoutdupl_norm_46.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..', 'data', 'semantic', 'Cardiotocography',
                                 'Cardiotocography_withoutdupl_norm_22.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..', 'data', 'semantic', 'HeartDisease',
                                 'HeartDisease_withoutdupl_norm_44.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..', 'data',
                                 'semantic', 'Hepatitis', 'Hepatitis_withoutdupl_norm_16.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..', 'data', 'semantic', 'InternetAds',
                                 'InternetAds_withoutdupl_norm_19.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..', 'data',
                                 'literature', 'Ionosphere', 'Ionosphere_withoutdupl_norm.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..',
                                 'data', 'literature', 'KDDCup99', 'KDDCup99_idf.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..', 'data',
                                 'literature', 'Lymphography', 'Lymphography_withoutdupl_idf.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..',
                                 'data', 'semantic', 'Pima', 'Pima_withoutdupl_norm_35.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..', 'data',
                                 'literature', 'Shuttle', 'Shuttle_withoutdupl_v01.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..',
                                 'data', 'semantic', 'SpamBase', 'SpamBase_withoutdupl_norm_40.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..',
                                 'data', 'semantic', 'Stamps', 'Stamps_withoutdupl_norm_09.arff')),
    os.path.abspath(os.path.join(os.path.join(os.path.dirname(__file__), '..', 'original_code', 'COPOD', 'results'), '..', 'data',
